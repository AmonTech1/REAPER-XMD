...
const config = {
    ...
    botOwner: process.env.BOT_OWNER || 'Amon',
    ownerNumber: process.env.OWNER_NUMBER || '2547XXXXXXXX',
    author: process.env.AUTHOR || 'Amon',
    ...
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/AmonTech1/REAPER-XMD/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'Amon',
    // Session
